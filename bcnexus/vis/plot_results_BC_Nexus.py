...
def main(nexus_scenario:str='Base_CNZ',
         timeslices:int=24,
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print("Usage: python plot_results_CLEWs.py <nexus_scenario> <timeslices>")
        sys.exit(1)
    
    nexus_scenario = sys.argv[1]
    timeslices = sys.argv[2]
    main(nexus_scenario=nexus_scenario, timeslices=timeslices)