"""
2024 | Delta E + Changes | Bruno Borba
Changes include: 
- Timelice conversion related adjustments to accomodate storage modelling algorithms (Kotzur, Niet etc.)

________________________________________________________________________________________________________________
Pre-process OSeMOSYS data file to reduce matrix generation time

Source: https://github.com/ClimateCompatibleGrowth/osemosys-cloud/blob/master/scripts/preprocess_data.py
                ...
                if 'var' in line:
                    ...
                    if var_count == 1:
                        if 'SEASON' in set_list:
                            ...
                            model_lines.append('set TIMESLICEofLDC{ldc in DAYSCRO} within DAYTYPE := {ld in DAYTYPE : Conversionldc[ld,ldc] = 1};\n')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 5:
        ...
        utils.print_update(level=3, message=msg.format(sys.argv[0]))
        sys.exit(1)
    else:
