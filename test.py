...
LandCluster_data ={
  'root': "models/BC_Nexus/data/clews_data/LandClusterData",
...
## Pasture types - generally do not change.
#IrrigationTypeList=self.cfg['IrrigationTypeList']
PastureTypeList : dict= {
'N': 'Natural pastures',
'C': 'Cultivated pastures'
}
...
LandUseCodes= {
  ...
  'PAS': 'Pastures for livestock',
  'AGV': 'Agrivoltaic land', #New land use code so that a new MOO is created
}
...
EvapotranspirationPercentPRCOtherLandUse= {
  ...
  'WAT': 0.571,
  'OTH': 0.694,
  'PAS': 0.694,#This needs to be corrected, this value is a test
  'AGV': 0.694 #This needs to be corrected, this value is a test
}
...
GroundwaterPercentofExcessOtherLandUse= {
  ...
  'WAT': 0.017,
  'OTH': 0.051,
  'PAS': 0.051, #This needs to be corrected, this value is a test
  'AGV': 0.694 #This needs to be corrected, this value is a test
}
...
# Livestock yield factors for calibrating the model
LivestockYieldFactors = {
