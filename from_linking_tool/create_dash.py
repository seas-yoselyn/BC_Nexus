...
if __name__ == "__main__":
    # visual_configs = load_config('config/visualization_config.yaml')
    title="Timeslice - Dashboard"
    font_size=16
    font_color='blue'
    width='auto'
    height='auto'

    plots_html_directory = "vis"
    index_html_directory = 'index.html'
    style_css_directory = 'style.css'
