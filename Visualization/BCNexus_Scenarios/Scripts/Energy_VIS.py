...
print("\033[1m**** Generating Plots for Generation and Consmption - for all Cases...\033[0m\n")
...
for scenario in SCENARIOS:
    ...
    for filename in filenames:
        ...
        plt.savefig(f'{output_directory}/Energy Generation-by Fuel_{scenario}.png', bbox_inches='tight')
        ...
        # Save the plot as a PNG file in the specified directory
        plt.savefig(f'{output_directory}/Energy Consumption (PJ) - by Sector_{scenario}.png', bbox_inches='tight')
    ...
    for filename in filenames2:
        ...
        if os.path.exists(file):
            ...
            # Save the plot as a PNG file in the specified directory
            plt.savefig(f'{output_directory}/Energy Consumption (PJ) - by fuel_{scenario}.png', bbox_inches='tight')
        else:
            print(f'{filename} -NOT FOUND in the BCNEXUS Scenario results directors')


    print(f"Plot created and saved for ------->> {scenario} Scenario")

print(f"\nGeneration and Consumption Plots generated successfully\n")