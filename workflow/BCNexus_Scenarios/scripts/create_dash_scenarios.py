...
if __name__ == "__main__":
    ...
    root = visual_configs['root']
    index_html_directory=os.path.join(root,'index.html')
    style_css_directory = os.path.join(root,'style.css')
    ...
    for scenario in SCENARIOS:
        ...
        plots_html_directory = f"scenario_plots/{scenario}"
        scenario_combined_html=f"scenario_plots/{scenario}.html"
        combine_plots_for_dash(plots_html_directory, scenario_combined_html,title,font_size,font_color)
